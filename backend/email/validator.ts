 ...
 */
export function validateEmail(email: string, options: ValidateEmailOptions = {}): Promise<VerificationResult> | VerificationResult {
 ...
 */
export function generatePermutations(localPart: string, domain: string): string[] {
