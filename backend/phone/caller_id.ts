 ...
 * @returns DeterministicProfile
 */
export function getDeterministicProfile(phone: string): DeterministicProfile {
  let hash = 0;
 ...
 * @returns CallerIdResult
 */
export async function lookupCallerID(phone: string, options: any = {}): Promise<CallerIdResult> {
