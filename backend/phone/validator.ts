 ...
 *
 * @param rawPhone - Raw phone number input
 * @param fallbackCountryCode - Fallback country code if not clear
 * @returns PhoneValidationResult
 */
export function validatePhone(rawPhone: string, fallbackCountryCode: string = 'VN'): PhoneValidationResult {
