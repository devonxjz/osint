...
const inputSecuritySchema = z.string()
  .min(1, { message: ERRORS.EMPTY })
  .max(100, { message: ERRORS.INPUT_TOO_LONG }) // Protect against ReDoS & Buffer Bloat
 ...
 */
function cleanDomainString(str: string): string {
 ...
 */
export function analyzeInput(input: any): AnalysisResult {
