...
import { EvasionResponse, EvasionRequestOptions } from '../username/engines/evasionClient';

export class PlaywrightStealthClient {
  /**
...
export const playwrightStealthClient = new PlaywrightStealthClient();
