...
exports.GLOBAL_HTML_BLACKLIST = void 0;
exports.isSoft404 = isSoft404;
exports.GLOBAL_HTML_BLACKLIST = [
    'page not found',
    'profile not found',
    'user not found',
    'cannot be found',
 ...
 */
function isSoft404(html, username, bio) {
    ...
    for (const phrase of exports.GLOBAL_HTML_BLACKLIST) {
