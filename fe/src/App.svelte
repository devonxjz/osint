...
<script lang="ts">
  ...
  // Instantiate centralized Svelte 5 reactive orchestrator
  // Connects to local express SSE server on port 3000
  const scanner = new ScannerState('http://localhost:3000');
</script>
