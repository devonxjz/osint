# Capability: Raw Scanner Output

## Purpose
TBD: This capability defines requirements for handling raw scanner input targets and routing/formatting raw outputs without rendering them to the client UI.
